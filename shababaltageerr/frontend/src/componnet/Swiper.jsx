...
export default function Swiperr(){
    let [image]=useState([
        ...
        {id:2,images:"./605b669d-c3b0-4fa7-bf98-dfc4e171868f.jpg",title:"امنح وقتك، وستحصد السعادة لمن حولك"},
        {id:3,images:"./f3c10a0f-2941-47df-936d-1cbe302379b9.jpg",title:"التطوع عمل الخير الذي لا يضيع أجره"},
        {id:4,images:"./a8ce5601-72d7-468f-af43-dfe01628af83.jpg",title:"العمل التطوعي يزرع الحب ويجمع القلوب"}
    ])
    return(
         <Swiper
        spaceBetween={30}
